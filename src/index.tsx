...
import { app, auth, decodeOneTimeCode, getOneTimeCode } from './firebaseConfig';
import { TwitterAuthProvider, signInWithCustomToken, signInWithPopup } from 'firebase/auth';
import styled from 'styled-components'
import { WalletProvider, useWallet } from './_hooks/useWallet';
...
const RequireSignIn: React.FC<{OnceSignedIn: React.FC}> = ({OnceSignedIn}) => {
  ...
  const IS_VALID_USER = user && hasSetAddress;
